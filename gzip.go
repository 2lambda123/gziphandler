...
const (
	...
	// 1500 bytes is the MTU size for the internet since that is the largest size allowed at the network layer. 1500 bytes is the minimum size until we enable gzip compression.
	// 1500 bytes is the minimum size until we enable gzip compression.
